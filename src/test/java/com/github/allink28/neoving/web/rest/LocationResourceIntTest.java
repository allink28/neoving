...
import com.github.allink28.neoving.repository.LocationRepository;
import com.github.allink28.neoving.service.LocationService;
import com.github.allink28.neoving.repository.search.LocationSearchRepository;
...
import static com.github.allink28.neoving.web.rest.TestUtil.createFormattingConversionService;
...
public class LocationResourceIntTest {
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getGuests()).isEqualTo(DEFAULT_GUESTS);
        assertThat(testLocation.getPrice()).isEqualTo(DEFAULT_PRICE);
    ...
    public void updateLocation() throws Exception {
        ...
        assertThat(testLocation.getGuests()).isEqualTo(UPDATED_GUESTS);
        assertThat(testLocation.getPrice()).isEqualTo(UPDATED_PRICE);
